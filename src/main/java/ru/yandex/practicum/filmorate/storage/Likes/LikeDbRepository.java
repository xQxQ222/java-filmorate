...
public class LikeDbRepository implements LikeStorage {
    ...
    public Optional<Film> likeFilm(int userId, int filmId) {
        ...
        final String queryF = "SELECT f.FILM_ID, f.FILM_DESCRIPTION,f.FILM_NAME,f.FILM_RELEASE_DATE,f.FILM_DURATION,f.GENRE_ID,f.MPA_RATING_ID, mr.rating_name, g.genre_name" +
                " FROM Film f" +
    ...
    public List<Film> getMostPopularFilms(int count) {
        final String query = "SELECT f.FILM_ID, f.FILM_DESCRIPTION,f.FILM_NAME,f.FILM_RELEASE_DATE,f.FILM_DURATION,f.GENRE_ID,f.MPA_RATING_ID, mr.rating_name, g.genre_name, COUNT(l.USER_ID) likes_count\n" +
                "FROM Film f \n" +
                "JOIN MPARATING mr ON f.MPA_RATING_ID=mr.Rating_id \n" +
